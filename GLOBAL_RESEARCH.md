# Global Research — gadget.codev.id
...
This is the reusable pre-writing evidence layer for the complete `gadget.codev.id` catalog. It reuses authoritative research from its broader project family, then maps that evidence to this repository's frozen topic families so related sites do not repeat the same source discovery.
...
- **Grade:** P.
- **Purpose:** Freeze the verified editorial scope for `gadget.codev.id` and prevent family research from overriding this project's actual catalog boundaries.
- **Summary:** `gadget.codev.id` is a member of **F10 Software, automation, domains, IoT, tools, and digital products**. Shared evidence is reused here, but its applicability is filtered through this project's topic map, application, jurisdiction, product, and installed-system gates.
...
- **Incorporation:** Use in `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-06`, `GDC-07`, `GDC-11`, `GDC-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-11`, `GDC-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-08`, `GDC-10`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-14`, `GDC-15`, `GDC-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-05`, `GDC-10`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-08`, `GDC-10`, `GDC-12`, `GDC-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-09`, `GDC-11`, `GDC-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-09`, `GDC-15`, `GDC-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-06`, `GDC-07`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-09`, `GDC-12`, `GDC-13`, `GDC-15`, `GDC-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-05`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-12`, `GDC-13`, `GDC-15`, `GDC-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `GDC-12`, `GDC-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
| --- | --- | --- | --- |
| `GDC-01` | KR-01, KR-02, KR-03, KR-05, KR-08 | Kebutuhan dan anggaran; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-02` | KR-01, KR-02, KR-03, KR-05, KR-08 | Memilih handphone bekas; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-03` | KR-01, KR-02, KR-03, KR-05, KR-08 | Memilih laptop bekas; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-04` | KR-01, KR-02, KR-03, KR-05, KR-08 | Kondisi fisik dan riwayat perbaikan; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-05` | KR-01, KR-05, KR-06, KR-08, KR-14 | Baterai dan pengisian daya; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-06` | KR-01, KR-02, KR-03, KR-08, KR-12 | Layar, kamera, audio, dan input; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-07` | KR-01, KR-02, KR-03, KR-08, KR-12 | Performa, penyimpanan, dan suhu; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-08` | KR-01, KR-03, KR-04, KR-05, KR-07 | Jaringan, konektivitas, dan port; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-09` | KR-01, KR-05, KR-08, KR-10, KR-13 | Identitas, keaslian, dan status perangkat; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-10` | KR-01, KR-04, KR-05, KR-06, KR-07 | Software, akun, keamanan, dan privasi; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-11` | KR-01, KR-02, KR-03, KR-05, KR-08 | Kelengkapan dan aksesori; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-12` | KR-01, KR-07, KR-13, KR-15, KR-17 | Penjual, transaksi, dan garansi; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-13` | KR-01, KR-07, KR-13, KR-15, KR-17 | Harga, nilai, dan biaya total; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-14` | KR-01, KR-02, KR-03, KR-05, KR-08 | Alur pemeriksaan sebelum membeli; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-15` | KR-01, KR-05, KR-10, KR-13, KR-15 | Setup dan perawatan setelah membeli; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `GDC-16` | KR-01, KR-05, KR-10, KR-13, KR-15 | Jual kembali, tukar tambah, dan akhir pakai; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
...
| --- | --- | --- |
| `GATE-01` project and user evidence | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify users, stakeholders, current process, constraints, baseline, requirements, and acceptance ownership. |
| `GATE-02` architecture and system inventory | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify the current system, data, dependencies, quality attributes, capacity/cost assumptions, alternatives, and decision records. |
| `GATE-03` security assurance | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Obtain a versioned threat model, control mapping, secure-development evidence, and qualified verification for the exact release. |
| `GATE-04` provider API and integration facts | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify current contracts, authentication, scopes, quotas, data flows, failure behavior, tests, terms, and exit path. |
| `GATE-05` Indonesian privacy and legal review | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify current Indonesian and sector rules, roles, data purposes and bases, rights, vendors/transfers, retention, incidents, and qualified legal review. |
| `GATE-06` test and release evidence | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Define release scope, environments, representative data/users, criteria, results, unresolved defects, exceptions, and decision owner. |
| `GATE-07` production and deployment evidence | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify actual runtime/account configuration, provider limits, secrets, deployment, migration, cache/network behavior, rollback, and smoke tests. |
| `GATE-08` measurement and operating evidence | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Use dated evidence with build, environment, sample, percentile, cache, tool/version, baseline, telemetry window, incident/cost context, and owner. |
| `GATE-09` commercial provider and handover evidence | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify current scope, entity/team, ownership, source/accounts, competence, subcontractors, support/warranty, results, handover, and exit. |
| `GATE-10` AI and automation controls | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Verify use-case baseline, data rights/provider handling, versioned evaluation, failure/abuse tests, human authority, monitoring, fallback, and retirement. |
| `GATE-11` device condition and consumer evidence | `GDC-01`, `GDC-02`, `GDC-03`, `GDC-04`, `GDC-05`, `GDC-06`, `GDC-07`, `GDC-08`, `GDC-09`, `GDC-10`, `GDC-11`, `GDC-12`, `GDC-13`, `GDC-14`, `GDC-15`, `GDC-16` | Obtain exact device identifiers, manufacturer diagnostics, battery/electrical/safety records, account/lock status, seller evidence, current consumer terms, and physical inspection. |
